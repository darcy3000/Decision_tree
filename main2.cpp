...
//vector<map<string,int> > atrr_type;
...
int main()
{
    ...
    //Changing index for fprunning
    /*index.clear();
    for(i=27000;i<32560;i++)
    {
        index.push_back(i);
    }*/
    ...
    /*for(i=0;i<15;i++){
        cout<<i<<"   ";
        for(j=0;j<vals_attr_vec[i].size();j++){
            cout<<vals_attr_vec[i][j]<<"    ";
        }
        cout<<endl;
    }*/
//cout<<"hELLO";
    /*for(i=0;i<14;i++){
        double ans=info_gain(i,index,lesser,more);
        cout<<ans<<endl;
